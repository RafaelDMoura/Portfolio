const projets = {
    ...
    multiburo: {
        ...
        <div class="pre">
            <div id="one">
                <p>Le profil</p>
                <img id="stage" src="CSS/IMG/ultiburo1.png" class="img-centre img-lightbox" onclick="openLightbox(this.src)">
            </div>
            <div id="two">
                <p>La profil quand vous-êtes connecter</p>
                <img id="stage" src="CSS/IMG/ultiburo2.png" class="img-centre img-lightbox" onclick="openLightbox(this.src)">
            </div>
        </div> <br>
        <div class="pre">
            <div id="one">
                <p>La Connection</p>
                <img id="stage" src="CSS/IMG/ultiburo3.png" class="img-centre img-lightbox" onclick="openLightbox(this.src)">
            </div>
            <div id="two">
                <p>L'Inscription</p>
                <img id="stage" src="CSS/IMG/ultiburo4.png" class="img-centre img-lightbox" onclick="openLightbox(this.src)">
            </div>
            <div id="three">
                <p>La réservation</p>
                <img id="stage" src="CSS/IMG/ultiburo5.png" class="img-centre img-lightbox" onclick="openLightbox(this.src)">
            </div>
        </div>`
    },
    gourmetise: {
